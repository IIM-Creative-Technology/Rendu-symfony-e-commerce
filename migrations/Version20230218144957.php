 ...
 */
final class Version20230218144957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produits (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, name VARCHAR(255) NOT NULL, prix DOUBLE PRECISION DEFAULT NULL, image VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, stock DOUBLE PRECISION DEFAULT NULL, INDEX IDX_BE2DDF8CBCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
